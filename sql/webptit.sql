...
INSERT INTO `orders` VALUES (5,13,'Bách Văn','0986853388','Hà Nội',2700,'2022-05-28','0'),(6,1,'Sơn','0986853388','bắc ninh',650,'2022-06-19','0');
...
CREATE TABLE IF NOT EXISTS replies (
    ...
    timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    foreign key(commentId) references comments(id) on update cascade
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;